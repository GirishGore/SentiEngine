...
public class SentiWordNet {
    ...
    public SentiWordNet(ConsoleDisplay consoleDisplay) throws IOException {
        ...
        if(dictionary.size() == 0)
        {
            ...
            try
            {
                ...
                if(dictionary.size() >= 1) {
                    consoleDisplay.DisplayOnConsole("Wordnet and SentiWordNet Dictionaries loaded ...");
                }
            }
        }
    }
    ...
    public double extract(String word, String pos) {
        Double a = dictionary.get(word + "#" + pos);
